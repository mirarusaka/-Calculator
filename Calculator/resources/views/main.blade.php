    ...
    {{-- ボタン それぞれリンクがつく Bootstrap5 使用--}}
        ...
        <div style="display:inline-flex">
            <form metod="post" action="">
                <button class="btn btn-danger rounded-circle p-0" style="width:4rem;height:4rem;">AC</button>
            </form>
            <form metod="post" action="">
        ...
        <div style="display:inline-flex">
            <form method="post" action={{ route('push') }}>
                @csrf
            <button type="submit" class="btn btn-primary rounded-circle p-0" style="width:4rem;height:4rem;" name="btn" value="1">1</button>
            </form>
            <form metod="post" action="">
